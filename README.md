...
(currently available from Steam). However, this may fail to work with
the game as downloaded via the Steam client on Windows, due to minor
differences in GAMETEXT.KDR (although this was corrected at some point).
...
----------------------------------------------------------------------------
Where can I get compatible Keen Dreams game data (updated as of Apr 23 2018)
----------------------------------------------------------------------------
...
2015 had a re-release of Keen Dreams on Steam
(previously also available from itch.io and IndieGameStand).
...
Store page: http://store.steampowered.com/app/356200/Keen_Dreams/
