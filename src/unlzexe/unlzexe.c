...
- Modified version based on v0.8. Can unpack EXEs made
with lzexe 0.91e, and also covers other small modifications.
 ...
 */
	...
	*ver = 91;						     /* v0.8 */
    ...
    if (memcmp (sigbuf, sig91e, sizeof sigbuf) == 0) {		     /* 0.91e compat */
	*ver = 91;						     /* 0.91e compat */
	return SUCCESS; 					     /* 0.91e compat */
    }								     /* 0.91e compat */
    return FAILURE;
}
