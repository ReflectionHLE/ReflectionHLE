...
; *** ALPHA RESTORATION ***
; Not sure what's this unused variable, but it's reset to 0 in the alpha
...
pixxloop:
; *** ALPHA RESTORATION ***
; An unused variable being reset to 0 just here
IF GAMEVER_WOLFREV LE GV_WR_WL920312
	mov	[BYTE unuseddrvar],0
ENDIF
