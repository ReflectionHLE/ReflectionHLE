...
#define	sc_F11			0x57
#define	sc_F12			0x59
// *** S3DNA RESTORATION *** - Let's just add this here for consistency
// with Blake Stone (although the exact location doesn't matter)
...
typedef	struct		{
						id0_boolean_t		button0,button1,button2,button3;
						id0_int_t			x,y;
						Motion		xaxis,yaxis;
						Direction	dir;
					} CursorInfo;
...
extern	id0_boolean_t		IN_UserInput(id0_longword_t delay);
