...
#define	STR_DADDY	"Super Easy"
#define	STR_HURTME	"Easy"
#define	STR_BRINGEM	"Normal"
#define	STR_DEATH	"Hard"
#else
...
// There was a typo fix
#if (GAMEVER_WOLFREV <= GV_WR_SODFG14A)
#define	STR_FRWD	"Fwrd"
#else
