...
static  id0_boolean_t         USL_CtlButtonCustom(UserCall,word,id0_word_t),
					USL_CtlPButtonCustom(UserCall,word,id0_word_t),
					USL_CtlPSButtonCustom(UserCall,word,id0_word_t),
					USL_CtlPRButtonCustom(UserCall,word,id0_word_t),
					USL_CtlHButtonCustom(UserCall,word,id0_word_t),
					USL_CtlDButtonCustom(UserCall,word,id0_word_t),
					USL_CtlDEButtonCustom(UserCall,word,id0_word_t),
					USL_CtlDLButtonCustom(UserCall,word,id0_word_t),
					USL_CtlDSButtonCustom(UserCall,word,id0_word_t),
					USL_CtlSButtonCustom(UserCall,word,id0_word_t),
					USL_CtlCButtonCustom(UserCall,word,id0_word_t),
					USL_CtlCKbdButtonCustom(UserCall,word,id0_word_t),
					USL_CtlCJoyButtonCustom(UserCall,word,id0_word_t);
...
typedef struct  {
					...
					id0_boolean_t         (*custom)(UserCall,word,id0_word_t);  // Custom routine
