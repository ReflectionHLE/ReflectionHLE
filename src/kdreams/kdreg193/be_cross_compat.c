...
{
	s_score.compatdosoffset = 0x0DC8;
	s_flowerpower1.compatdosoffset = 0x0DE6;
	s_flowerpower2.compatdosoffset = 0x0E04;
	s_boobusbomb1.compatdosoffset = 0x0E22;
	s_boobusbomb2.compatdosoffset = 0x0E40;
	s_bombexplode.compatdosoffset = 0x0E5E;
	s_bombexplode2.compatdosoffset = 0x0E7C;
	s_bombexplode3.compatdosoffset = 0x0E9A;
	s_bombexplode4.compatdosoffset = 0x0EB8;
	s_bombexplode5.compatdosoffset = 0x0ED6;
	s_bombexplode6.compatdosoffset = 0x0EF4;
	s_powerblink1.compatdosoffset = 0x0F12;
	s_powerblink2.compatdosoffset = 0x0F30;
	s_worldkeen.compatdosoffset = 0x0F4E;
	s_worldkeenwave1.compatdosoffset = 0x0F6C;
	s_worldkeenwave2.compatdosoffset = 0x0F8A;
	s_worldkeenwave3.compatdosoffset = 0x0FA8;
	s_worldkeenwave4.compatdosoffset = 0x0FC6;
	s_worldkeenwave5.compatdosoffset = 0x0FE4;
	s_worldkeenwait.compatdosoffset = 0x1002;
	s_worldkeensleep1.compatdosoffset = 0x1020;
	s_worldkeensleep2.compatdosoffset = 0x103E;
	s_worldwalk.compatdosoffset = 0x105C;
	s_keenzee1.compatdosoffset = 0x1092;
	s_keenzee2.compatdosoffset = 0x10B0;
	s_keenzee3.compatdosoffset = 0x10CE;
	s_keenstand.compatdosoffset = 0x10EC;
	s_keenpauselook.compatdosoffset = 0x110A;
	s_keenyawn1.compatdosoffset = 0x1128;
	s_keenyawn2.compatdosoffset = 0x1146;
	s_keenyawn3.compatdosoffset = 0x1164;
	s_keenyawn4.compatdosoffset = 0x1182;
	s_keenwait1.compatdosoffset = 0x11A0;
	s_keenwait2.compatdosoffset = 0x11BE;
	s_keenwait3.compatdosoffset = 0x11DC;
	s_keenwait4.compatdosoffset = 0x11FA;
	s_keenwait5.compatdosoffset = 0x1218;
	s_keenwait6.compatdosoffset = 0x1236;
	s_keengosleep1.compatdosoffset = 0x1254;
	s_keengosleep2.compatdosoffset = 0x1272;
	s_keensleep1.compatdosoffset = 0x1290;
	s_keensleep2.compatdosoffset = 0x12AE;
	s_keengetup.compatdosoffset = 0x12CC;
	s_keendie1.compatdosoffset = 0x12EA;
	s_keendie2.compatdosoffset = 0x1308;
	s_keendie3.compatdosoffset = 0x1326;
	s_keenlookup.compatdosoffset = 0x1344;
	s_keenduck.compatdosoffset = 0x1362;
	s_keendrop.compatdosoffset = 0x1380;
	s_keenpole.compatdosoffset = 0x139E;
	s_keenclimb1.compatdosoffset = 0x13BC;
	s_keenclimb2.compatdosoffset = 0x13DA;
	s_keenclimb3.compatdosoffset = 0x13F8;
	s_keenslide1.compatdosoffset = 0x1416;
	s_keenslide2.compatdosoffset = 0x1434;
	s_keenslide3.compatdosoffset = 0x1452;
	s_keenslide4.compatdosoffset = 0x1470;
	s_keenpolethrow1.compatdosoffset = 0x148E;
	s_keenpolethrow2.compatdosoffset = 0x14AC;
	s_keenpolethrow3.compatdosoffset = 0x14CA;
	s_keenpolethrowup1.compatdosoffset = 0x14E8;
	s_keenpolethrowup2.compatdosoffset = 0x1506;
	s_keenpolethrowup3.compatdosoffset = 0x1524;
	s_keenpolethrowdown1.compatdosoffset = 0x1542;
	s_keenpolethrowdown2.compatdosoffset = 0x1560;
	s_keenpolethrowdown3.compatdosoffset = 0x157E;
	s_keenwalk1.compatdosoffset = 0x159C;
	s_keenwalk2.compatdosoffset = 0x15BA;
	s_keenwalk3.compatdosoffset = 0x15D8;
	s_keenwalk4.compatdosoffset = 0x15F6;
	s_keenthrow1.compatdosoffset = 0x1614;
	s_keenthrow2.compatdosoffset = 0x1632;
	s_keenthrow3.compatdosoffset = 0x1650;
	s_keenthrow4.compatdosoffset = 0x166E;
	s_keenthrowup1.compatdosoffset = 0x168C;
	s_keenthrowup2.compatdosoffset = 0x16AA;
	s_keenthrowup3.compatdosoffset = 0x16C8;
	s_keenjumpup1.compatdosoffset = 0x16E6;
	s_keenjumpup2.compatdosoffset = 0x1704;
	s_keenjumpup3.compatdosoffset = 0x1722;
	s_keenjump1.compatdosoffset = 0x1740;
	s_keenjump2.compatdosoffset = 0x175E;
	s_keenjump3.compatdosoffset = 0x177C;
	s_keenairthrow1.compatdosoffset = 0x179A;
	s_keenairthrow2.compatdosoffset = 0x17B8;
	s_keenairthrow3.compatdosoffset = 0x17D6;
	s_keenairthrowup1.compatdosoffset = 0x17F4;
	s_keenairthrowup2.compatdosoffset = 0x1812;
	s_keenairthrowup3.compatdosoffset = 0x1830;
	s_keenairthrowdown1.compatdosoffset = 0x184E;
	s_keenairthrowdown2.compatdosoffset = 0x186C;
	s_keenairthrowdown3.compatdosoffset = 0x188A;
	s_door.compatdosoffset = 0x1946;
	s_doorraise.compatdosoffset = 0x1964;
	s_flower1.compatdosoffset = 0x1982;
	s_flower2.compatdosoffset = 0x19A0;
	s_flower3.compatdosoffset = 0x19BE;
	s_flower4.compatdosoffset = 0x19DC;
	s_flower5.compatdosoffset = 0x19FA;
	s_flower6.compatdosoffset = 0x1A18;
	s_poofto1.compatdosoffset = 0x1A36;
	s_poofto2.compatdosoffset = 0x1A54;
	s_poofto3.compatdosoffset = 0x1A72;
	s_poofto4.compatdosoffset = 0x1A90;
	s_pooffrom1.compatdosoffset = 0x1AAE;
	s_pooffrom2.compatdosoffset = 0x1ACC;
	s_pooffrom3.compatdosoffset = 0x1AEA;
	s_pooffrom4.compatdosoffset = 0x1B08;
	s_pooffrom5.compatdosoffset = 0x1B26;
	s_pooffrom6.compatdosoffset = 0x1B44;
	s_pooffrom7.compatdosoffset = 0x1B62;
	s_bonus.compatdosoffset = 0x1B80;
	s_bonusrise.compatdosoffset = 0x1B9E;
	s_broccowalk1.compatdosoffset = 0x1BD4;
	s_broccowalk2.compatdosoffset = 0x1BF2;
	s_broccowalk3.compatdosoffset = 0x1C10;
	s_broccowalk4.compatdosoffset = 0x1C2E;
	s_broccosmash1.compatdosoffset = 0x1C4C;
	s_broccosmash2.compatdosoffset = 0x1C6A;
	s_broccosmash3.compatdosoffset = 0x1C88;
	s_broccosmash4.compatdosoffset = 0x1CA6;
	s_broccosmash5.compatdosoffset = 0x1CC4;
	s_broccosmash6.compatdosoffset = 0x1CE2;
	s_broccosmash7.compatdosoffset = 0x1D00;
	s_broccosmash8.compatdosoffset = 0x1D1E;
	s_broccosmash9.compatdosoffset = 0x1D3C;
	s_tomatbounce.compatdosoffset = 0x1D5A;
	s_tomatbounce2.compatdosoffset = 0x1D78;
	s_carrotwalk1.compatdosoffset = 0x1D96;
	s_carrotwalk2.compatdosoffset = 0x1DB4;
	s_carrotwalk3.compatdosoffset = 0x1DD2;
	s_carrotwalk4.compatdosoffset = 0x1DF0;
	s_carrotleap.compatdosoffset = 0x1E0E;
	s_asparwalk1.compatdosoffset = 0x1E2C;
	s_asparwalk2.compatdosoffset = 0x1E4A;
	s_asparwalk3.compatdosoffset = 0x1E68;
	s_asparwalk4.compatdosoffset = 0x1E86;
	s_grapewait.compatdosoffset = 0x1EA4;
	s_grapefall.compatdosoffset = 0x1EC2;
	s_grapesit.compatdosoffset = 0x1EE0;
	s_graperise.compatdosoffset = 0x1EFE;
	s_taterwalk1.compatdosoffset = 0x1F1C;
	s_taterwalk2.compatdosoffset = 0x1F3A;
	s_taterwalk3.compatdosoffset = 0x1F58;
	s_taterwalk4.compatdosoffset = 0x1F76;
	s_taterattack1.compatdosoffset = 0x1F94;
	s_taterattack2.compatdosoffset = 0x1FB2;
	s_taterattack3.compatdosoffset = 0x1FD0;
	s_cartroll1.compatdosoffset = 0x1FEE;
	s_cartroll2.compatdosoffset = 0x200C;
	s_frenchywalk1.compatdosoffset = 0x202A;
	s_frenchywalk2.compatdosoffset = 0x2048;
	s_frenchywalk3.compatdosoffset = 0x2066;
	s_frenchywalk4.compatdosoffset = 0x2084;
	s_frenchyrun1.compatdosoffset = 0x20A2;
	s_frenchyrun2.compatdosoffset = 0x20C0;
	s_frenchyrun3.compatdosoffset = 0x20DE;
	s_frenchyrun4.compatdosoffset = 0x20FC;
	s_frenchythrow1.compatdosoffset = 0x211A;
	s_frenchythrow2.compatdosoffset = 0x2138;
	s_frenchythrow3.compatdosoffset = 0x2156;
	s_fry1.compatdosoffset = 0x2174;
	s_fry2.compatdosoffset = 0x2192;
	s_melonside.compatdosoffset = 0x21B0;
	s_melonsidespit.compatdosoffset = 0x21CE;
	s_melonsidespit2.compatdosoffset = 0x21EC;
	s_melondown.compatdosoffset = 0x220A;
	s_melondownspit.compatdosoffset = 0x2228;
	s_melondownspit2.compatdosoffset = 0x2246;
	s_melonseed1.compatdosoffset = 0x2264;
	s_melonseed2.compatdosoffset = 0x2282;
	s_melonseedd1.compatdosoffset = 0x22A0;
	s_melonseedd2.compatdosoffset = 0x22BE;
	s_squasherwalk1.compatdosoffset = 0x22DC;
	s_squasherwalk2.compatdosoffset = 0x22FA;
	s_squasherjump1.compatdosoffset = 0x2318;
	s_squasherjump2.compatdosoffset = 0x2336;
	s_squasherwait.compatdosoffset = 0x2354;
	s_apelwalk1.compatdosoffset = 0x2372;
	s_apelwalk2.compatdosoffset = 0x2390;
	s_apelwalk3.compatdosoffset = 0x23AE;
	s_apelclimb1.compatdosoffset = 0x23CC;
	s_apelclimb2.compatdosoffset = 0x23EA;
	s_apelslide1.compatdosoffset = 0x2408;
	s_apelslide2.compatdosoffset = 0x2426;
	s_apelslide3.compatdosoffset = 0x2444;
	s_apelslide4.compatdosoffset = 0x2462;
	s_apelfall.compatdosoffset = 0x2480;
	s_peabrainfly.compatdosoffset = 0x249E;
	s_peabrainwalk1.compatdosoffset = 0x24BC;
	s_peabrainwalk2.compatdosoffset = 0x24DA;
	s_peabrainwalk3.compatdosoffset = 0x24F8;
	s_peabrainwalk4.compatdosoffset = 0x2516;
	s_peapodwalk1.compatdosoffset = 0x2534;
	s_peapodwalk2.compatdosoffset = 0x2552;
	s_peapodwalk3.compatdosoffset = 0x2570;
	s_peapodwalk4.compatdosoffset = 0x258E;
	s_peapodspit1.compatdosoffset = 0x25AC;
	s_peapodspit2.compatdosoffset = 0x25CA;
	s_boobuswalk1.compatdosoffset = 0x25E8;
	s_boobuswalk2.compatdosoffset = 0x2606;
	s_boobuswalk3.compatdosoffset = 0x2624;
	s_boobuswalk4.compatdosoffset = 0x2642;
	s_boobusjump.compatdosoffset = 0x2660;
	s_boobusdie.compatdosoffset = 0x267E;
	s_boobusdie2.compatdosoffset = 0x269C;
	s_boobusdie3.compatdosoffset = 0x26BA;
	s_deathboom1.compatdosoffset = 0x26D8;
	s_deathboom2.compatdosoffset = 0x26F6;
	s_deathboom3.compatdosoffset = 0x2714;
	s_deathboom4.compatdosoffset = 0x2732;
	s_deathboom5.compatdosoffset = 0x2750;
	s_deathboom6.compatdosoffset = 0x276E;
}
