...
LOCAL_C_INCLUDES := $(SDL_PATH)/include $(SRC) $(BESRC) $(C3DCOMMONSRC) $(IDSRC) $(EXTSRC)

RESAMPLER := LIBSPEEXDSP

LOCAL_CFLAGS += -DREFKEEN_VER_CATADVENTURES=1 -DREFKEEN_VER_CATABYSS=1 -DREFKEEN_VER_CATACOMB_ALL=1 -DREFKEEN_RESAMPLER_$(RESAMPLER) -DREFKEEN_ENABLE_LAUNCHER
