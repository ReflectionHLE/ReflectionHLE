...
#define BUT_JUMP_MAP       &g_binding_value_button[0], 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_SHOOT_MAP      &g_binding_value_button[1], 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_STATS_MAP      &g_binding_value_stats, 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_GRENADE_MAP    &g_binding_value_grenade, 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_LOOKUP_MAP     &g_binding_value_lookup, 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_LOOKDOWN_MAP   &g_binding_value_lookdown, 0, 2, BE_ST_CTRL_MAP_VALUESET
#define BUT_SCOREBOX_MAP   &g_binding_value_scorebox, 0, 2, BE_ST_CTRL_MAP_VALUESET
