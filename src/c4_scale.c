...
// (CHOCO CAT) Replacement for functions generated by BuildCompShape
static void ExecuteCompShape(const id0_byte_t *codePtr, id0_byte_t *comptablebuff, id0_unsigned_t egaDestOff, const id0_byte_t *srcGfxPtr, id0_byte_t mask)
{
	...
	while (*currCodePtr != 0xcb)
	{
		...
		id0_byte_t *scalerFarRetPtr = comptablebuff + *(id0_unsigned_t *)(comptablebuff+(*(id0_unsigned_t *)(currCodePtr+2)));
		id0_byte_t scalerPreFarRet = *scalerFarRetPtr;
		*scalerFarRetPtr = 0xcb; // far return
		ExecuteCompScale(comptablebuff + *(id0_unsigned_t *)(comptablebuff+(*(id0_unsigned_t *)(currCodePtr+10))), egaDestOff, srcGfxPtr+(*(id0_unsigned_t *)(currCodePtr+19)), mask);
		*scalerFarRetPtr = scalerPreFarRet; // unpatch far return
		currCodePtr += 29;
	}
}
...
//
	...
	//
		...
		if ((id0_unsigned_t)longtemp == badcodeptr)
			Quit ("ScaleShape: codehandle past end!");
#endif
		id0_unsigned_t egaDestOff = (pixel>>3) + bufferofs;
