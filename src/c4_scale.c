...
void ExecuteCompScale(const t_compscale *compscale, id0_unsigned_t egaDestOff, id0_byte_t *srcPtr, id0_byte_t mask)
{
...
//
	for (x=firstline;x<=lastline;x++)
	{
		...
		BE_SDL_EGAUpdateGFXBuffer(workEgaOff+offsetof(t_compshape, codeofs[x-firstline]), (uint8_t *)&tempUnsignedWord, sizeof(tempUnsignedWord), 1);
