...
{
	s_score.compatdosoffset = 0x0BB4;
	s_flowerpower1.compatdosoffset = 0x0BD2;
	s_flowerpower2.compatdosoffset = 0x0BF0;
	s_boobusbomb1.compatdosoffset = 0x0C0E;
	s_boobusbomb2.compatdosoffset = 0x0C2C;
	s_bombexplode.compatdosoffset = 0x0C4A;
	s_bombexplode2.compatdosoffset = 0x0C68;
	s_bombexplode3.compatdosoffset = 0x0C86;
	s_bombexplode4.compatdosoffset = 0x0CA4;
	s_bombexplode5.compatdosoffset = 0x0CC2;
	s_bombexplode6.compatdosoffset = 0x0CE0;
	s_powerblink1.compatdosoffset = 0x0CFE;
	s_powerblink2.compatdosoffset = 0x0D1C;
	s_worldkeen.compatdosoffset = 0x0D3A;
	s_worldkeenwave1.compatdosoffset = 0x0D58;
	s_worldkeenwave2.compatdosoffset = 0x0D76;
	s_worldkeenwave3.compatdosoffset = 0x0D94;
	s_worldkeenwave4.compatdosoffset = 0x0DB2;
	s_worldkeenwave5.compatdosoffset = 0x0DD0;
	s_worldkeenwait.compatdosoffset = 0x0DEE;
	s_worldkeensleep1.compatdosoffset = 0x0E0C;
	s_worldkeensleep2.compatdosoffset = 0x0E2A;
	s_worldwalk.compatdosoffset = 0x0E48;
	s_keenzee1.compatdosoffset = 0x0E7E;
	s_keenzee2.compatdosoffset = 0x0E9C;
	s_keenzee3.compatdosoffset = 0x0EBA;
	s_keenstand.compatdosoffset = 0x0ED8;
	s_keenpauselook.compatdosoffset = 0x0EF6;
	s_keenyawn1.compatdosoffset = 0x0F14;
	s_keenyawn2.compatdosoffset = 0x0F32;
	s_keenyawn3.compatdosoffset = 0x0F50;
	s_keenyawn4.compatdosoffset = 0x0F6E;
	s_keenwait1.compatdosoffset = 0x0F8C;
	s_keenwait2.compatdosoffset = 0x0FAA;
	s_keenwait3.compatdosoffset = 0x0FC8;
	s_keenwait4.compatdosoffset = 0x0FE6;
	s_keenwait5.compatdosoffset = 0x1004;
	s_keenwait6.compatdosoffset = 0x1022;
	s_keengosleep1.compatdosoffset = 0x1040;
	s_keengosleep2.compatdosoffset = 0x105E;
	s_keensleep1.compatdosoffset = 0x107C;
	s_keensleep2.compatdosoffset = 0x109A;
	s_keengetup.compatdosoffset = 0x10B8;
	s_keendie1.compatdosoffset = 0x10D6;
	s_keendie2.compatdosoffset = 0x10F4;
	s_keendie3.compatdosoffset = 0x1112;
	s_keenlookup.compatdosoffset = 0x1130;
	s_keenduck.compatdosoffset = 0x114E;
	s_keendrop.compatdosoffset = 0x116C;
	s_keenpole.compatdosoffset = 0x118A;
	s_keenclimb1.compatdosoffset = 0x11A8;
	s_keenclimb2.compatdosoffset = 0x11C6;
	s_keenclimb3.compatdosoffset = 0x11E4;
	s_keenslide1.compatdosoffset = 0x1202;
	s_keenslide2.compatdosoffset = 0x1220;
	s_keenslide3.compatdosoffset = 0x123E;
	s_keenslide4.compatdosoffset = 0x125C;
	s_keenpolethrow1.compatdosoffset = 0x127A;
	s_keenpolethrow2.compatdosoffset = 0x1298;
	s_keenpolethrow3.compatdosoffset = 0x12B6;
	s_keenpolethrowup1.compatdosoffset = 0x12D4;
	s_keenpolethrowup2.compatdosoffset = 0x12F2;
	s_keenpolethrowup3.compatdosoffset = 0x1310;
	s_keenpolethrowdown1.compatdosoffset = 0x132E;
	s_keenpolethrowdown2.compatdosoffset = 0x134C;
	s_keenpolethrowdown3.compatdosoffset = 0x136A;
	s_keenwalk1.compatdosoffset = 0x1388;
	s_keenwalk2.compatdosoffset = 0x13A6;
	s_keenwalk3.compatdosoffset = 0x13C4;
	s_keenwalk4.compatdosoffset = 0x13E2;
	s_keenthrow1.compatdosoffset = 0x1400;
	s_keenthrow2.compatdosoffset = 0x141E;
	s_keenthrow3.compatdosoffset = 0x143C;
	s_keenthrow4.compatdosoffset = 0x145A;
	s_keenthrowup1.compatdosoffset = 0x1478;
	s_keenthrowup2.compatdosoffset = 0x1496;
	s_keenthrowup3.compatdosoffset = 0x14B4;
	s_keenjumpup1.compatdosoffset = 0x14D2;
	s_keenjumpup2.compatdosoffset = 0x14F0;
	s_keenjumpup3.compatdosoffset = 0x150E;
	s_keenjump1.compatdosoffset = 0x152C;
	s_keenjump2.compatdosoffset = 0x154A;
	s_keenjump3.compatdosoffset = 0x1568;
	s_keenairthrow1.compatdosoffset = 0x1586;
	s_keenairthrow2.compatdosoffset = 0x15A4;
	s_keenairthrow3.compatdosoffset = 0x15C2;
	s_keenairthrowup1.compatdosoffset = 0x15E0;
	s_keenairthrowup2.compatdosoffset = 0x15FE;
	s_keenairthrowup3.compatdosoffset = 0x161C;
	s_keenairthrowdown1.compatdosoffset = 0x163A;
	s_keenairthrowdown2.compatdosoffset = 0x1658;
	s_keenairthrowdown3.compatdosoffset = 0x1676;
	s_door.compatdosoffset = 0x1732;
	s_doorraise.compatdosoffset = 0x1750;
	s_flower1.compatdosoffset = 0x176E;
	s_flower2.compatdosoffset = 0x178C;
	s_flower3.compatdosoffset = 0x17AA;
	s_flower4.compatdosoffset = 0x17C8;
	s_flower5.compatdosoffset = 0x17E6;
	s_flower6.compatdosoffset = 0x1804;
	s_poofto1.compatdosoffset = 0x1822;
	s_poofto2.compatdosoffset = 0x1840;
	s_poofto3.compatdosoffset = 0x185E;
	s_poofto4.compatdosoffset = 0x187C;
	s_pooffrom1.compatdosoffset = 0x189A;
	s_pooffrom2.compatdosoffset = 0x18B8;
	s_pooffrom3.compatdosoffset = 0x18D6;
	s_pooffrom4.compatdosoffset = 0x18F4;
	s_pooffrom5.compatdosoffset = 0x1912;
	s_pooffrom6.compatdosoffset = 0x1930;
	s_pooffrom7.compatdosoffset = 0x194E;
	s_bonus.compatdosoffset = 0x196C;
	s_bonusrise.compatdosoffset = 0x198A;
	s_broccowalk1.compatdosoffset = 0x19C0;
	s_broccowalk2.compatdosoffset = 0x19DE;
	s_broccowalk3.compatdosoffset = 0x19FC;
	s_broccowalk4.compatdosoffset = 0x1A1A;
	s_broccosmash1.compatdosoffset = 0x1A38;
	s_broccosmash2.compatdosoffset = 0x1A56;
	s_broccosmash3.compatdosoffset = 0x1A74;
	s_broccosmash4.compatdosoffset = 0x1A92;
	s_broccosmash5.compatdosoffset = 0x1AB0;
	s_broccosmash6.compatdosoffset = 0x1ACE;
	s_broccosmash7.compatdosoffset = 0x1AEC;
	s_broccosmash8.compatdosoffset = 0x1B0A;
	s_broccosmash9.compatdosoffset = 0x1B28;
	s_tomatbounce.compatdosoffset = 0x1B46;
	s_tomatbounce2.compatdosoffset = 0x1B64;
	s_carrotwalk1.compatdosoffset = 0x1B82;
	s_carrotwalk2.compatdosoffset = 0x1BA0;
	s_carrotwalk3.compatdosoffset = 0x1BBE;
	s_carrotwalk4.compatdosoffset = 0x1BDC;
	s_carrotleap.compatdosoffset = 0x1BFA;
	s_asparwalk1.compatdosoffset = 0x1C18;
	s_asparwalk2.compatdosoffset = 0x1C36;
	s_asparwalk3.compatdosoffset = 0x1C54;
	s_asparwalk4.compatdosoffset = 0x1C72;
	s_grapewait.compatdosoffset = 0x1C90;
	s_grapefall.compatdosoffset = 0x1CAE;
	s_grapesit.compatdosoffset = 0x1CCC;
	s_graperise.compatdosoffset = 0x1CEA;
	s_taterwalk1.compatdosoffset = 0x1D08;
	s_taterwalk2.compatdosoffset = 0x1D26;
	s_taterwalk3.compatdosoffset = 0x1D44;
	s_taterwalk4.compatdosoffset = 0x1D62;
	s_taterattack1.compatdosoffset = 0x1D80;
	s_taterattack2.compatdosoffset = 0x1D9E;
	s_taterattack3.compatdosoffset = 0x1DBC;
	s_cartroll1.compatdosoffset = 0x1DDA;
	s_cartroll2.compatdosoffset = 0x1DF8;
	s_frenchywalk1.compatdosoffset = 0x1E16;
	s_frenchywalk2.compatdosoffset = 0x1E34;
	s_frenchywalk3.compatdosoffset = 0x1E52;
	s_frenchywalk4.compatdosoffset = 0x1E70;
	s_frenchyrun1.compatdosoffset = 0x1E8E;
	s_frenchyrun2.compatdosoffset = 0x1EAC;
	s_frenchyrun3.compatdosoffset = 0x1ECA;
	s_frenchyrun4.compatdosoffset = 0x1EE8;
	s_frenchythrow1.compatdosoffset = 0x1F06;
	s_frenchythrow2.compatdosoffset = 0x1F24;
	s_frenchythrow3.compatdosoffset = 0x1F42;
	s_fry1.compatdosoffset = 0x1F60;
	s_fry2.compatdosoffset = 0x1F7E;
	s_melonside.compatdosoffset = 0x1F9C;
	s_melonsidespit.compatdosoffset = 0x1FBA;
	s_melonsidespit2.compatdosoffset = 0x1FD8;
	s_melondown.compatdosoffset = 0x1FF6;
	s_melondownspit.compatdosoffset = 0x2014;
	s_melondownspit2.compatdosoffset = 0x2032;
	s_melonseed1.compatdosoffset = 0x2050;
	s_melonseed2.compatdosoffset = 0x206E;
	s_melonseedd1.compatdosoffset = 0x208C;
	s_melonseedd2.compatdosoffset = 0x20AA;
	s_squasherwalk1.compatdosoffset = 0x20C8;
	s_squasherwalk2.compatdosoffset = 0x20E6;
	s_squasherjump1.compatdosoffset = 0x2104;
	s_squasherjump2.compatdosoffset = 0x2122;
	s_squasherwait.compatdosoffset = 0x2140;
	s_apelwalk1.compatdosoffset = 0x215E;
	s_apelwalk2.compatdosoffset = 0x217C;
	s_apelwalk3.compatdosoffset = 0x219A;
	s_apelclimb1.compatdosoffset = 0x21B8;
	s_apelclimb2.compatdosoffset = 0x21D6;
	s_apelslide1.compatdosoffset = 0x21F4;
	s_apelslide2.compatdosoffset = 0x2212;
	s_apelslide3.compatdosoffset = 0x2230;
	s_apelslide4.compatdosoffset = 0x224E;
	s_apelfall.compatdosoffset = 0x226C;
	s_peabrainfly.compatdosoffset = 0x228A;
	s_peabrainwalk1.compatdosoffset = 0x22A8;
	s_peabrainwalk2.compatdosoffset = 0x22C6;
	s_peabrainwalk3.compatdosoffset = 0x22E4;
	s_peabrainwalk4.compatdosoffset = 0x2302;
	s_peapodwalk1.compatdosoffset = 0x2320;
	s_peapodwalk2.compatdosoffset = 0x233E;
	s_peapodwalk3.compatdosoffset = 0x235C;
	s_peapodwalk4.compatdosoffset = 0x237A;
	s_peapodspit1.compatdosoffset = 0x2398;
	s_peapodspit2.compatdosoffset = 0x23B6;
	s_boobuswalk1.compatdosoffset = 0x23D4;
	s_boobuswalk2.compatdosoffset = 0x23F2;
	s_boobuswalk3.compatdosoffset = 0x2410;
	s_boobuswalk4.compatdosoffset = 0x242E;
	s_boobusjump.compatdosoffset = 0x244C;
	s_boobusdie.compatdosoffset = 0x246A;
	s_boobusdie2.compatdosoffset = 0x2488;
	s_boobusdie3.compatdosoffset = 0x24A6;
	s_deathboom1.compatdosoffset = 0x24C4;
	s_deathboom2.compatdosoffset = 0x24E2;
	s_deathboom3.compatdosoffset = 0x2500;
	s_deathboom4.compatdosoffset = 0x251E;
	s_deathboom5.compatdosoffset = 0x253C;
	s_deathboom6.compatdosoffset = 0x255A;
}
