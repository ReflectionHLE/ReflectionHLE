...
int main(int argc, char **argv) {
	...
	printf("\n");
	printf("void RefKeen_FillObjStatesWithDOSPointers(void)\n");
	printf("{\n");
#ifdef GENERATE_FARPTR_MAPPINGS
	printf("\tg_farPtrExeLocSegOffset = ((uint_fast32_t)RefKeen_GetFarPtrRelocationSegOffset()) * 0x10000;\n");
#endif
	for (i = 0, currEntry = mappingTable; i < mapCounter; ++i, ++currEntry) {
	...
	printf("\n");
	printf("void *RefKeen_GetObjStatePtrFromDOSPointer(uint_fast32_t dosptr)\n");
	printf("{\n");
#ifdef GENERATE_FARPTR_MAPPINGS
